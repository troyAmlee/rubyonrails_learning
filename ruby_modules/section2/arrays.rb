# a = (1..10).to_a
# x = ("a".."z").to_a
#  %w(blah blah blah do something here) == [blah, blah, blah, do, something, here]

a = [1, 2, 3, 4, 5, 6, 7, 8 ,9]
p a.last

a.reverse # Will not mutate the original array
a.reverse! # Will mutate the original array
